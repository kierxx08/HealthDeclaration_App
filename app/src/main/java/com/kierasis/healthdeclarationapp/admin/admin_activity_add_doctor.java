...
public class admin_activity_add_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.aad_doc_toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        admin_activity_add_doctor.this.setTitle("Add Doctor");
        toolbar.getNavigationIcon().setColorFilter(getResources().getColor(R.color.admin_tc), PorterDuff.Mode.SRC_ATOP);

        fname = findViewById(R.id.aad_doc_fname);
        lname = findViewById(R.id.aad_doc_lname);
        pnumber = findViewById(R.id.aad_doc_pnumber);
        sex = findViewById(R.id.aad_doc_sex);
        save = findViewById(R.id.aad_doc_save);

        final Calendar myCalendar = Calendar.getInstance();

        final EditText bday = (EditText) findViewById(R.id.aad_doc_bday);
        ...
        bday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(admin_activity_add_doctor.this, date, 1970, 00,
                        01).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(txtFname) || TextUtils.isEmpty(txtLname)){
                    Toast.makeText(admin_activity_add_doctor.this,"All Fields Required", Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(bday.getText().toString())){
                    Toast.makeText(admin_activity_add_doctor.this,"Please Select Birthday", Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(txtMobile)){
                    Toast.makeText(admin_activity_add_doctor.this,"All Fields Required", Toast.LENGTH_SHORT).show();
                }else if(txtMobile.length()!=10){
                    Toast.makeText(admin_activity_add_doctor.this,"Invalid Phone Number", Toast.LENGTH_SHORT).show();
                }else if(txtSex.equals("Please Choose")){
                    Toast.makeText(admin_activity_add_doctor.this,"Please Choose Sex", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void save(final String txtFname,final String txtLname,final String txtBday,final String txtMobile,final String txtSex) {
        final ProgressDialog progressDialog = new ProgressDialog(admin_activity_add_doctor.this, R.style.MyAlertDialogStyle);
        progressDialog.setCancelable(false);
        progressDialog.setIndeterminate(false);
        progressDialog.setTitle("Registering Account");
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        String uRl = "https://hda-server.000webhostapp.com/app/admin_add_doctor.php";
        StringRequest request = new StringRequest(Request.Method.POST, uRl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("Success")){
                    ...
                    Toast.makeText(admin_activity_add_doctor.this, "Registered", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(admin_activity_add_doctor.this, admin_activity_add_doctor_success.class);
                    startActivity(intent);
                    finish();
                }else{
                    Toast.makeText(admin_activity_add_doctor.this, response, Toast.LENGTH_SHORT).show();
                }
            }
        ...
        my_singleton.getInstance(admin_activity_add_doctor.this).addToRequestQueue(request);
    }
