...
import com.kierasis.healthdeclarationapp.doctor.doctor_activity_view_patient_finish;
import com.kierasis.healthdeclarationapp.doctor.doctor_activity_view_patient_medicine;
import com.kierasis.healthdeclarationapp.doctor.doctor_activity_view_patient_prescribe;
import com.kierasis.healthdeclarationapp.doctor.doctor_adapter_view_patient_prescribe;
import com.kierasis.healthdeclarationapp.doctor.doctor_ext_view_patient_prescribe;
...
public class family_activity_medical_record_view extends AppCompatActivity implements doctor_adapter_view_patient_prescribe.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.family_activity_medical_record_view);

        androidx.appcompat.widget.Toolbar toolbar = (Toolbar) findViewById(R.id.famrv_toolbar);
        setSupportActionBar(toolbar);
        family_activity_medical_record_view.this.setTitle("");
        ...
        p_id = findViewById(R.id.famrv_mem_id);
        p_name = findViewById(R.id.famrv_fullname);
        p_age = findViewById(R.id.famrv_age);
        p_height = findViewById(R.id.famrv_height);
        p_weight = findViewById(R.id.famrv_weight);
        p_temp = findViewById(R.id.famrv_temp);
        p_bp = findViewById(R.id.famrv_bp);
        p_sick = findViewById(R.id.famrv_sick);
        ...
        if(from.equals("famain")){
            search2 = String.valueOf(user_info.getString("position",""));
        }else{
            search2 = intent.getStringExtra("member_id");;
        }
        ...
        recyclerView = findViewById(R.id.famrv_prescribe_list);
        cases = new ArrayList<>();

        no_net = findViewById(R.id.famrv_no_net);
        no_data = findViewById(R.id.famrv_no_data);
        loader = findViewById(R.id.famrv_loader);
        loader2 = findViewById(R.id.famrv_med_load);
        scroll = findViewById(R.id.famrv_scroll);
        refresh = findViewById(R.id.famrv_refresh);
    ...
    private void get_info(final String from, final String data) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, uRl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("Success")){
                    ...
                    Toast.makeText(family_activity_medical_record_view.this, response, Toast.LENGTH_SHORT).show();
                    no_net.setVisibility(View.GONE);
        ...
        my_singleton.getInstance(family_activity_medical_record_view.this).addToRequestQueue(request);
    }
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if(0<response.length()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(family_activity_medical_record_view.this));
                    adapter = new doctor_adapter_view_patient_prescribe(family_activity_medical_record_view.this, cases, family_activity_medical_record_view.this);
    ...
    private void finish(final String id) {
        final ProgressDialog progressDialog = new ProgressDialog(family_activity_medical_record_view.this, R.style.default_dialog);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, uRl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("Success")){
                    startActivity(new Intent(family_activity_medical_record_view.this, doctor_activity_view_patient_finish.class));
                    finish();
                }else{
                    Toast.makeText(family_activity_medical_record_view.this, response, Toast.LENGTH_SHORT).show();no_net.setVisibility(View.GONE);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(family_activity_medical_record_view.this, "Error", Toast.LENGTH_SHORT).show();no_net.setVisibility(View.GONE);
                progressDialog.dismiss();
            }
        }){
            @Override
