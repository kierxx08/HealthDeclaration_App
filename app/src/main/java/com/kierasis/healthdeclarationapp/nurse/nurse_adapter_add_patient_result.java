...
public class nurse_adapter_add_patient_result extends RecyclerView.Adapter<nurse_adapter_add_patient_result.ViewHolder> {
    LayoutInflater inflater;
    List<nurse_ext_add_patient_result> cases;
    private OnNoteListener mOnNoteListener;

    public nurse_adapter_add_patient_result(Context ctx, List<nurse_ext_add_patient_result> cases, OnNoteListener onCaseListener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.nurse_activity_add_patient_result_list,parent, false);
